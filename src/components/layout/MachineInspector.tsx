...
export function MachineInspector() {
  ...
  if (!object || object.assetType !== "MACHINE") return <aside className="machine-inspector panel"><div className="inspector-kicker">MACHINE INSPECTOR</div><h2>No machine selected</h2><p>Select a CNC machine in the 3D factory to view live operating data.</p></aside>;
